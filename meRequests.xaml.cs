...
{
    public partial class meRequests : PhoneApplicationPage
    {
        ...
        {
            myOwnCity = e.Fragment.ToString();
            myurlcity = "http://www.techiesin.com/dogood/?s=" + e.Fragment.ToString() + "&feed=rss2";
            timeloadText.Text = "getting results for - " + e.Fragment.ToString(); ;
            timeloadText.Visibility = Visibility.Visible;
            timelinePB.Visibility = Visibility.Visible;
        ...
        private void refreshIcon_Menu(object sender, EventArgs e)
        {
            ...
            timeloadText.Text = "refreshing the list, please wait";
            timeloadText.Visibility = Visibility.Visible;
            timelinePB.Visibility = Visibility.Visible;
        ...
        private void webClient_DownloadStringCompletedRefresh(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    ...
                    timeloadText.Text = "refresh failed, check your internet connectivity";
                    timelinePB.Visibility = Visibility.Collapsed;
            ...
            else
            {
                ...
                timeloadText.Visibility = Visibility.Collapsed;
                timelinePB.Visibility = Visibility.Collapsed;
        ...
        private void webClient_DownloadStringCompletedCity(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    // Showing the exact error message is useful for debugging. In a finalized application, 
                    // output a friendly and applicable string to the user instead. 
                    timeloadText.Text = "no results for this city, change it again";
                    timelinePB.Visibility = Visibility.Collapsed;
                 });
            }
            else
        ...
        private void webClient_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    ...
                    timeloadText.Text = "check your internet connectivity";
                    timelinePB.Visibility = Visibility.Collapsed;
        ...
        private void UpdateFeedList(string feedXML)
        {
            ...
            Deployment.Current.Dispatcher.BeginInvoke(() =>
            {
                ...
                {
                    timeloadText.Text = "showing results for your city: " + myOwnCity;
                    timeloadText.Visibility = Visibility.Visible;
                }
